...
def get_ai_provider() -> AIProvider:
    ...
    match provider_name:
        case "openai":
            from interviews.providers.openai import OpenAIProvider
        ...
        case "anthropic":
            from interviews.providers.anthropic import AnthropicProvider
        ...
        case "ollama":
            from interviews.providers.ollama import OllamaProvider

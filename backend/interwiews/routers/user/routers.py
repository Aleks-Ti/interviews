...
from interwiews.routers.user.depends import user_usecase as _user_usecase
...
async def change_user_is_allowed_comment(
    ...
    try:
        ...
        raise HTTPException(status_code=403, detail="Администратор не может запретить комментирование для другого администратора и автора блога.")
    except Exception as err:
